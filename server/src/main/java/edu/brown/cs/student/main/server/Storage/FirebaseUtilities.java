...
public class FirebaseUtilities implements StorageInterface {
  ...
  public Map<String, String> getUsers(String uid)
    ...
    Iterable<DocumentReference> friendRequests = userRef.collection("outgoingFriendRequests").listDocuments()
    ...
    for (DocumentReference ref : db.collection("users").listDocuments()) {
      ...
      if (!ref.getId().equals(uid) && !friends.contains(ref.getId()) && !friendRequestIDs.contains(ref.getId())) {
